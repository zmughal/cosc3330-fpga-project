...
function NiceTitles(sTemplate, nDelay, nStringMaxLength, nMarginX, nMarginY, sContainerID, sClassName){
	...
	function setContainerContent(sOutput){
		sOutput = sOutput.replace(/&/g, "&amp;").replace(/\n/g, "<br/>");
	...
	function getViewport(){
		...
		x = window.pageXOffset ? window.pageXOffset : window.scrollX ? window.scrollX : x;
		y = window.pageYOffset ? window.pageYOffset : window.scrollY ? window.scrollY : y;
...
NiceTitles.autoCreation = function(){
	...
	NiceTitles.autoCreated.anchors = new NiceTitles("<p class=\"titletext\">attr(nicetitle)? <span class=\"accesskey\">[attr(accesskey)]</span>?</p><p class=\"destination\">attr(href)</p>", delay);
	NiceTitles.autoCreated.acronyms = new NiceTitles("<p class=\"titletext\">content(): attr(nicetitle)</p>", delay);
	//for image nicetitles based off alt tags
	NiceTitles.autoCreated.images = new NiceTitles("<p class=\"titletext\">attr(nicetitle)</p>", delay);
	//for form nicetitles. just add title to input and textarea tags
	NiceTitles.autoCreated.input = new NiceTitles("<p class=\"titletext\">attr(nicetitle)</p><p class=\"destination\">? <span class=\"accesskey\">Accesskey : [attr(accesskey)]</span>?</p>", delay);
	NiceTitles.autoCreated.simple = new NiceTitles("<p class=\"titletext\">attr(nicetitle)</p>", delay);
...
//	NiceTitles.autoCreated.input.addElements(document.getElementsByTagName("textarea"), "id"); //added
	NiceTitles.autoCreated.simple.addElements(document.getElementsByTagName("div"), "title");
	NiceTitles.autoCreated.simple.addElements(document.getElementsByTagName("span"), "title");
	NiceTitles.autoCreated.simple.addElements(document.getElementsByTagName("button"), "title");
}
